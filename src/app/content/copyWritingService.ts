export const copyWritingServiceContent = [
    {
        ...
        titleMedium: "The Best Copywriting Service in UK",
        firstdescription: ["A professional press release can mean the difference between a story being picked up by the media and it is ignored. The kind of press that advertising money just can’t buy. By raising the bar on the quality of your business writing you communicate to the world that you are professionals that should be taken seriously.",
